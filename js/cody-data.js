...
const COMPANIES = [
  ...
  { id:"junction", name:"Junction Bioscience", vertical:"health",
    ...
    jobs:[
      { title:"Operations Associate (Test Kit)", url:"https://jobs.ashbyhq.com/junction/22a94673-4605-4e0e-8979-3b81a59f4e67", level:"entry", pay:{"min":80000.0,"max":95000.0,"interval":"year"}, paySource:"posted", summary:"Own the operational execution of new customer test kit launches, ensuring milestones are tracked, dependencies are managed, and programs are ready for successful go-live - Coordinate\u2026" }
    ] },
  { id:"runway", name:"Runway", vertical:"ai",
    ...
    jobs:[
      { title:"Consumer Support Specialist - US", url:"https://jobs.ashbyhq.com/runway-ml/9f6d216d-2f54-4970-84d7-43ab0a2b4852", level:"entry", pay:{"min":75000.0,"max":90000.0,"interval":"year"}, paySource:"posted", summary:"We are building AI to simulate the world through merging art and science. We believe that world models are at the frontier of progress in artificial intelligence." },
      { title:"Creative Support Specialist, Enterprise", url:"https://jobs.ashbyhq.com/runway-ml/f6e8f3fa-0440-484e-92f7-6ae2e67f1d07", level:"entry", pay:{"min":100000.0,"max":145000.0,"interval":"year"}, paySource:"posted", summary:"We are building AI to simulate the world through merging art and science. We believe that world models are at the frontier of progress in artificial intelligence." }
    ] },
  { id:"squarespace", name:"Squarespace", vertical:"saas",
    ...
    jobs:[
      { title:"Customer Support Associate (Remote)", url:"https://www.squarespace.com/about/careers?gh_jid=8139231", level:"entry", pay:{"min":17.0,"max":25.0,"interval":"hour"}, paySource:"estimate", years:1, summary:"Troubleshoot and guide customers through questions and issues with their Account, Billing, Domain, or other transactional inquiries Independently meet targets across Quality, Productivity\u2026" }
    ] },
...
const COMPANY_DOMAINS = {
  runway:'runwayml.com', deepgram:'deepgram.com', squarespace:'squarespace.com',
  talkspace:'talkspace.com', wealthfront:'wealthfront.com', camber:'camber.com',
  drw:'drw.com', databento:'databento.com', junction:'junction.bio',
  hasbro:'hasbro.com',
};
